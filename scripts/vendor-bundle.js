...
;
define('aurelia-http-client/dist/commonjs/aurelia-http-client',['require','exports','module','aurelia-path','aurelia-pal'],function (require, exports, module) {'use strict';
...
define('aurelia-http-client',['aurelia-http-client/dist/commonjs/aurelia-http-client'],function(m){return m;});
...
define('resources/models/concept',['__dot_dot__/src/models/concept'],function(m){return m;});
define('resources/models/member',['__dot_dot__/src/models/member'],function(m){return m;});
define('resources/models/tree',['__dot_dot__/src/models/tree'],function(m){return m;});
define('resources/oe-thesaurus-component',['__dot_dot__/src/oe-thesaurus-component'],function(m){return m;});
define('text!resources/oe-thesaurus-component.html',['text!__dot_dot__/src/oe-thesaurus-component.html'],function(m){return m;});
define('resources/oe-thesaurus-input',['__dot_dot__/src/oe-thesaurus-input'],function(m){return m;});
define('text!resources/oe-thesaurus-input.html',['text!__dot_dot__/src/oe-thesaurus-input.html'],function(m){return m;});
define('resources/oe-thesaurus-tree',['__dot_dot__/src/oe-thesaurus-tree'],function(m){return m;});
define('text!resources/oe-thesaurus-tree.html',['text!__dot_dot__/src/oe-thesaurus-tree.html'],function(m){return m;});
define('resources/services/api-service',['__dot_dot__/src/services/api-service'],function(m){return m;});
define('resources/tree-node',['__dot_dot__/src/tree-node'],function(m){return m;});
define('text!resources/tree-node.html',['text!__dot_dot__/src/tree-node.html'],function(m){return m;});
...
function _aureliaConfigureModuleLoader(){requirejs.config({
  ...
  "bundles": {
    "app-bundle": [
      ...
      "__dot_dot__/src/models/concept",
      "__dot_dot__/src/models/member",
      "__dot_dot__/src/models/tree",
      "__dot_dot__/src/oe-thesaurus-component",
      "text!__dot_dot__/src/oe-thesaurus-component.html",
      "__dot_dot__/src/oe-thesaurus-input",
      "text!__dot_dot__/src/oe-thesaurus-input.html",
      "__dot_dot__/src/oe-thesaurus-tree",
      "text!__dot_dot__/src/oe-thesaurus-tree.html",
      "__dot_dot__/src/services/api-service",
      "__dot_dot__/src/tree-node",
      "text!__dot_dot__/src/tree-node.html",
      "app",
      "environment",
      "main"
    ]
